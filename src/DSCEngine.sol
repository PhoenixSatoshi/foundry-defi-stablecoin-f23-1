 ...
 *    and reddeeming DSC, as well as depositing & withdrawing collateral.
...
contract DSCEngine is ReentrancyGuard {
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); //I don't think this would ever hit-ask in audit
    }
    ...
    * @notice A known bug would be if the protocol were 100% or less collateralized, then we wouldn't be able to incentivize the 
      liquidator.
    ...
    */
    function _burnDsc(uint256 amountDscToBurn, address onBahalfOf, address dscFrom) private {
        s_DSCMinted[onBahalfOf] -= amountDscToBurn;
